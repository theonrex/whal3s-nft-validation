  ...
  toast.custom(
    (t) => (
      ...
      >
        ...
        <div
          className={
            "flex flex-col items-start justify-center ml-4 cursor-default"
          }
        >
          <h1
            className={
              "text-base text-gray-200 font-semibold leading-none tracking-wider"
            }
          >
            {title}
          </h1>
          <p
            className={
              "text-sm text-gray-400 mt-2 leading-relaxed tracking-wider"
            }
          >
            {message}
          </p>
